...
public class OnResultSdaKrFoActivity extends AppCompatActivity {
    private TextView description;
    private TextView general_provisions;
    private ModelSdaKR modelSdaKrFo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_result_sda_kr_fo);
        ...
        modelSdaKrFo = (ModelSdaKR) getIntent().getSerializableExtra("SdaKr");

        description = findViewById(R.id.sda_kr_on_result_text);
        description.setTextSize(mRatio + 15);
        description.setText(modelSdaKrFo.getDescription());

        general_provisions = findViewById(R.id.sda_kr_on_result);

        general_provisions.setText(modelSdaKrFo.getGeneral_provisions());
        description.setText(modelSdaKrFo.getDescription().replaceAll("xx", System.getProperty("line.separator")));
