...
public class OnResultSdaKrFifActivity extends AppCompatActivity {
    private TextView description;
    private TextView general_provisions;
    private ModelSdaKR modelSdaKrFif;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_result_sda_kr_fif);
        ...
        modelSdaKrFif = (ModelSdaKR) getIntent().getSerializableExtra("SdaKr");
        ...
        description.setText(modelSdaKrFif.getDescription());
        description.setText(modelSdaKrFif.getDescription().replaceAll("xx", System.getProperty("line.separator")));
