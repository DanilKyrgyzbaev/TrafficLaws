...
public class OnResultSdaKrSevenActivity extends AppCompatActivity {
    private TextView description;
    private TextView general_provisions;
    private ModelSdaKR modelSdaKrSeven;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_result_sda_kr_seven);
        ...
        modelSdaKrSeven = (ModelSdaKR) getIntent().getSerializableExtra("SdaKr");
        ...
        description.setText(modelSdaKrSeven.getDescription());
        description.setText(modelSdaKrSeven.getDescription().replaceAll("xx", System.getProperty("line.separator")));
