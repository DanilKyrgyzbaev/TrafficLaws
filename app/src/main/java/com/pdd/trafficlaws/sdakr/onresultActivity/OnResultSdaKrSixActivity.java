...
public class OnResultSdaKrSixActivity extends AppCompatActivity {
    private TextView description;
    private TextView general_provisions;
    private ModelSdaKR modelSdaKrSix;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_result_sda_kr_six);
        ...
        modelSdaKrSix = (ModelSdaKR) getIntent().getSerializableExtra("SdaKr");
        ...
        description.setText(modelSdaKrSix.getDescription());
        description.setText(modelSdaKrSix.getDescription().replaceAll("xx", System.getProperty("line.separator")));
